...
(def t-fn-x [:fn nil :x t-var-0])
(def t-fn-y [:fn nil :y t-var-1])
(def t-fn-x-y [:fn nil :x t-fn-y])
...
(deftest shift
  ...
  (is (= [:fn nil :x [:var nil 0]]
         (term/shift 1 t-fn-x)))
  (is (= [:fn nil :y [:var nil 2]]
         (term/shift 1 t-fn-y)))
  (is (= [:fn nil :x [:fn nil :y [:var nil 1]]]
